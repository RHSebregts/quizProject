export const quizData = {
  ...
  questions: [
...

    {
      ...
      imgLink: 'public/assets/question-images/3.jpg',
    },

    {
      ...
      imgLink: 'public/assets/question-images/4.jpg',
    },

    {
      text: 'Who composed the score for Tenet?',
      answers: {
        a: 'Hans Zimmer',
        b: 'Ludwig Göransson',
        c: 'Trent Reznor',
    ...
    {
      text: 'Where was Luke Skywalker born?',
      answers: {
        a: 'Alderaan',
        b: 'Tatooine',
        c: 'Coruscant',
