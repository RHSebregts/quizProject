...
export const createWelcomeElement = () => {
  ...
  element.innerHTML = String.raw`
        ...
        <p>
        Think you’re a true movie buff or a TV series expert? Test your knowledge with this fun and challenging quiz! From legendary 
        quotes to award-winning films, see if you can pick the right answers and prove you're the ultimate entertainment fan!
        </p>
        <label for="user-name" id="name-label" class="display-block">Enter your name and age to begin</label>
        <div class="input-container">
          ...
          <button id="${START_QUIZ_BUTTON_ID}" class="display-block">Start the quiz</button>
        </div>
