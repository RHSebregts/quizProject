...
export const QUESTION_IMAGE_ID = 'question-image';
export const QUESTION_EXPLANATION_ID = 'question-explanation';
export const QUESTION_NUMBER_ID = 'question-number';
export const ANSWERS_LIST_ID = 'answers-list';
export const PROGRESS_BAR_ID = 'progress-bar';
export const RESTART_BUTTON_ID = 'restart-quiz';
